...
#' @name vanguard_balanced_funds
#' @docType data
#' @source \url{https://investor.vanguard.com/mutual-funds/list?assetclass=bond#/mutual-funds/asset-class/month-end-returns}
NULL
#'
#' Vanguard Bond ETFs and Inception Dates
#' @name vanguard_bond_etfs
#' @docType data
